...
def get_asistente_agent(message):
    goal = f"Asistente de Redacción, ambos trabajamos en Fin.Gurú y compartimos un interés común en colaborar para completar con éxito una tarea asignada por un nuevo cliente. Perfeccionar los artículos escritos por el equipo de periodistas de Fin.Gurú. Redacta un borrador de artículo sobre esto: {message}, y estar en el mismo lenguaje del mensaje, si el mensaje está en español devolver el resultado en español, o si está en inglés en ingles"
