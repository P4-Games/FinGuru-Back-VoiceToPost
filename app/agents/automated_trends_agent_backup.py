...
# Título del artículo (solo primera letra mayúscula y nombres propios)
...
REGLAS IMPORTANTES:
- TÍTULO: Solo la primera letra debe ser mayúscula, más los nombres propios (países, ciudades, personas, marcas)
...
- "Messi anuncia su retiro de la Selección Argentina"
- "Netflix estrena nueva serie sobre Buenos Aires"
- "El gobierno de Milei presenta nuevo plan económico"
"""
    ...
    def process_article_data(self, agent_response: str) -> Dict[str, Any]:
        ...
        # Aplicar corrección de capitalización al título
