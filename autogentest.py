...
groupchat = autogen.GroupChat(agents=[
                              periodista, asitente, editor, marketing,  director,redactor], messages=[], max_round=12)
